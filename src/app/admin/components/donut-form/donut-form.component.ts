  ...
  template: `
    <form class="donut-form" #form="ngForm">
      <label>
        ...
        required minlength="5" [ngModel]="donut.name" [ngModelOptions]="{ updateOn: 'blur' }" #name="ngModel"/>        
<ng-container *ngIf="name.invalid && name.touched">
  <div class="donut-form-error" *ngIf="name.errors?.required">Name is required.</div>
  <div class="donut-form-error" *ngIf="name.errors?.minlength">Minimal length of a name is 5!</div>
...
<button type="button" class="btn btn--red" (click)="handleDelete()">Delete</button>
